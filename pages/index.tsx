      ...
      <div className="page-padding mx-auto">
        ...
        <section className="lg:max-w-6xl lg:mx-auto">
          <section className="card bg-white text-dark grid gap-3">
            ...
            <p className="p">
              Werk is designed and developed to help you in your remote or
              hybrid working journey. You can collaborate and communicate in
              Werk seamlessly, easily.
            </p>
          </section>
            ...
            <div className="grid lg:grid-cols-3 gap-8 px-8">
              <div className="card bg-dark-gray my-base">
                ...
                <p className="p text-medium-gray">
                  ...
                  illum sed praesentium eligendi fuga repellat temporibus nam
                  minima harum. Quisquam!
                </p>
              </div>
              <div className="card bg-dark-gray my-base">
          ...
          <section className="card my-4 bg-green text-dark grid gap-3">
            ...
            <p className="text-medium-gray p">
              ...
              <span className="text-dark">
                But, you can asynchronously collaborate on Werk via Async
                Records feature!
              </span>
            </p>
          ...
          <section className="lg:flex gap-10">
            <article className="card my-4 bg-light-gray shadow-md text-dark grid gap-3 lg:w-1/2">
            ...
            <article className="card my-4 bg-dark grid gap-3 lg:w-1/2">
              ...
              <p className="p text-medium-gray">
                ...
                convesation with thread chat. Also share files, hyperdocs and
                more.
              </p>
              <div className="relative h-80 w-full">
                <Image
          ...
          <section className="card bg-green text-dark grid gap-3">
            ...
            <div className="relative h-80 lg:h-[50rem] w-full">
              <Image
            ...
            <Link href="/">
              <a className="button text-center h3 bg-dark text-light-gray mb-4 lg:w-max lg:mx-auto lg:px-8 lg:py-4 lg:text-5xl">
                Get Started
              </a>
            </Link>
          </section>
          ...
          <section className='lg:grid lg:grid-cols-2 grid-flow-row auto-rows-max gap-10'>

            <article className="card bg-dark grid gap-3">
            ...
            <article className="card bg-light-gray text-dark grid gap-3 h-3/4">
              <h2 className="h2">Voice Chat</h2>
              <p className="p">
                We know... Getting sync for every issue is hard.{' '}
                <span className="text-medium-gray">
              ...
              <Link href="/">
                <a className="button text-center h3 border-2 border-dark mb-4 h-max w-max mx-auto">
                  Go to Downloads
                </a>
              </Link>
            </article>
            ...
            <article className="card bg-light-gray text-dark grid gap-3">
              <h2 className="h2">Voice Chat</h2>
              <p className="p">
                We know... Getting sync for every issue is hard.{' '}
                <span className="text-medium-gray">
